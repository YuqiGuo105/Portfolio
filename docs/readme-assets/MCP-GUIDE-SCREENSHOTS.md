...
| `admin-sign-in.png` | Local preview `http://127.0.0.1:3092/admin/login`, captured with Computer Use on 2026-09-16 at 390 x 640 | Updated responsive sign-in before authorization; empty fields, no credentials |
