        ...
        <div className="flex items-center gap-3 border-b border-slate-800 px-5 py-4">
          <div className="flex flex-1 items-center gap-3 rounded-xl bg-slate-800 px-3">
            ...
            <input
              ...
              className="flex-1 h-10 bg-transparent py-3 text-lg text-white placeholder:text-slate-400 focus:outline-none"
          ...
          <select
            ...
            className="search-select rounded-xl border border-slate-700 bg-slate-800 px-3 py-2 text-sm font-medium text-white focus:outline-none"
          >
