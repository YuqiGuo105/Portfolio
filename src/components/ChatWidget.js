  ...
  return (
    <div className="bot-container relative mb-6 flex flex-col h-[80vh] w-screen md:w-[520px] overflow-hidden rounded-2xl bg-white shadow-2xl ring-1 ring-gray-200 backdrop-blur dark:bg-gray-900 dark:ring-gray-700">
      ...
      <form onSubmit={sendMessage} className="border-t border-gray-200 bg-gray-50/60 px-2 py-2">
        <div className="bot-actions flex items-center">
          <div className="flex flex-1 items-center overflow-hidden rounded-full border border-gray-200 bg-white dark:border-gray-700 dark:bg-gray-800">
            <label className="flex h-11 w-11 items-center justify-center border-r border-gray-200 text-gray-500 hover:bg-gray-100 dark:border-gray-700 dark:text-gray-300 dark:hover:bg-gray-800 cursor-pointer">
            ...
            <div className="relative flex flex-1 items-center">
              <input
                ...
                className="bot-input h-11 w-full border-transparent bg-transparent px-3 pr-12 text-sm outline-none focus:border-blue-500"
              />
            ...
            <button
              ...
              className="send-button flex h-11 w-12 items-center justify-center border-l border-gray-200 bg-blue-600 text-white hover:bg-blue-700 dark:border-gray-700 disabled:opacity-50"
            >
